...
const Top = () => {
    return (
        <div className={`container overflow-hidden`}>
            <p data-aos='slide-right' className={styles.heading}>About MazaoHub</p>
            ...
            <p data-aos='fade-up' data-aos-offset='80' className={styles.content}>
                MazaoHub is a digital platform designed to empower small-scale farmers by addressing the critical challenges they face in agriculture. 
                Acting as a one-stop solution, MazaoHub connects farmers with buyers, input suppliers, and agro-professionals, enabling them to operate efficiently and profitably.
            </p>
            ...
            <div className={`row ${styles.contain} flex-column-reverse flex-md-row`}>
                <div data-aos='slide-right' className={`col-md-6`}>
                    ...
                    <p className={styles.contn}>
                        ...
                        Accessible via mobile and web applications, MazaoHub is designed to cater to farmers in rural areas by offering multilingual support, mobile-friendly interfaces, and offline connectivity options through SMS and USSD. The platform’s holistic approach fosters collaboration, enhances productivity, and creates a sustainable agricultural ecosystem that uplifts farming communities and contributes to global food security. 
            With a vision to transform agriculture and a mission to empower farmers, MazaoHub is not just a platform; it’s a movement to modernize and democratize farming for small-scale producers worldwide.
                    </p>
                </div>
