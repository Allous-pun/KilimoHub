...
import { FaTachometerAlt, FaBullhorn, FaUserTie } from 'react-icons/fa'; // Import the icons
            ...
            <div className={`container ${styles.contain} overflow-hidden`}>
                ...
                <div className="row">
                    <div className="col-md-4" data-aos='fade-right' data-aos-offset="150">
                        <FaTachometerAlt className={`${styles.icon} ${styles.iconLarge}`} /> {/* Replacing timer.png with FaTachometerAlt */}
                    ...
                    <div className="col-md-4" data-aos='fade' data-aos-offset="150">
                        <FaBullhorn className={`${styles.icon} ${styles.iconLarge}`} /> {/* Replacing det.png with FaBullhorn */}
                    ...
                    <div className="col-md-4" data-aos='fade-left' data-aos-offset="150">
                        <FaUserTie className={`${styles.icon} ${styles.iconLarge}`} /> {/* Replacing tren.png with FaUserTie */}
                        ...
                        idx % 2 === 0 ?
                            <div key={idx} className="row" style={{ marginTop: '112px' }}>
                                <div data-aos='slide-right' data-aos-offset="150" className="col-md-6">
                                    <img src={x.img} alt="" className={styles.contentImg} /> {/* Keep the rest of the images as is */}
                                </div>
