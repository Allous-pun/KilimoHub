            ...
            <div className="row g-0">
                ...
                <div className="col-md-6">
                    <div className={styles.text}>
                        <p data-aos='slide-right' data-aos-offset="150" className={styles.heading}>FarmUnity</p>
                        ...
                        <p data-aos='zoom-in' data-aos-offset="150" className={styles.content}>
                            FarmUnity transforms agriculture by connecting farmers to resources, markets, and financial services. 
